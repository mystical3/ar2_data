...
local v2 = false;
local function v4(_) --[[ Line: 12 ]] --[[ Name: drag ]]

end;
l_UserInputService_0.InputChanged:Connect(function(v5, _) --[[ Line: 18 ]]
...
l_UserInputService_0.InputEnded:Connect(function(v7, _) --[[ Line: 25 ]]
    -- upvalues: v2 (ref)
...
return function(v9, v10) --[[ Line: 31 ]]
    ...
    l_Dragger_0.MouseButton1Down:Connect(function() --[[ Line: 38 ]]
        -- upvalues: v13 (ref), l_Dragger_0 (copy), v1 (ref), v2 (ref)
        v13 = l_Dragger_0.AbsolutePosition.X - v1.X;
        v2 = true;
    end);
    v4 = function(v14, _) --[[ Line: 43 ]] --[[ Name: drag ]]
